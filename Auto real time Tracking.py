...
# Fonction de rappel pour la détection des clics de souris
...
# Vérifier si la webcam a été ouverte correctement
...
while True:
    # Lire une nouvelle frame depuis la webcam
...
times = [t - times[0] for t in times]  # Correction de l'échelle de temps
velocities_kmh = [v * 3.6 for v in velocities]  # Conversion de m/s en km/h
plt.plot(times, velocities_kmh)
plt.xlabel("Temps (s)")
plt.ylabel("Vitesse (km/h)")
plt.title("Vitesse de l'objet en fonction du temps")
